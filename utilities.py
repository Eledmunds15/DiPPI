...
def set_path(path=None):
    ...
    - If `path` is provided, set the working directory to that path.
    - If not, set it to the directory of the running script.
    """
    if path:
    ...
    # print(f"[DEBUG] Working directory set to: {target_dir}")
